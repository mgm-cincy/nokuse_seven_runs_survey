...
sr_sf %>% 
  group_by(stream_type) %>% 
  summarize(st_length((sum(geometry))))
...
From <https://usepa.github.io/spsurvey/articles/weighting.html> use sp_rbind to bind 
rows of base and overdraw samples as all sites need to be evaluated in a survey.
```{r base_overdraw}
